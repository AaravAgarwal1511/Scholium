// Query-param handling for /open?paper=<id>&title=<name>, the entry point for a
// paper handed off from Past Papers. Pulled out of OpenPaperPage so the parsing
// and the same-origin redirect target can be unit tested without rendering React.
