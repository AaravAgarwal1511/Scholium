...
export default function Auth({ defaultMode = "signin" }: AuthProps) {
  ...
  // is another in-app link (the navbar, or a note page's sign-in prompt), so it
  // is always a same-origin path — but a leading "//" is still parsed as a
  ...
  return (
    <AuthCard
      ...
      hint="Sign in to browse and read the notes."
